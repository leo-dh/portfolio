...
const Icon = (props: ReactSVGProps): JSX.Element => {
  return <svg fill="currentColor" width="24" height="24" {...props} />;
};

export const HandWavingIcon = (props: ReactSVGProps): JSX.Element => {
  return (
    <Icon
      width="41"
      height="41"
...
export const OfficalGitHubIcon = (props: ReactSVGProps): JSX.Element => {
  return (
...
export const GitHubIcon = (props: ReactSVGProps): JSX.Element => {
  return (
    <Icon
      viewBox="0 0 24 24"
      strokeWidth="2"
...
export const MenuIcon = (props: ReactSVGProps): JSX.Element => {
  return (
...
export const CrossIcon = (props: ReactSVGProps): JSX.Element => {
  return (
...
export const AboutIcon = (props: ReactSVGProps): JSX.Element => {
  return (
    <Icon fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path
        strokeLinecap="round"
...
export const ContactIcon = (props: ReactSVGProps): JSX.Element => {
  return (
    <Icon fill="none" viewBox="0 0 24 24" stroke="currentColor" {...props}>
      <path
        strokeLinecap="round"
...
export const PaperAirplaneIcon = (props: ReactSVGProps): JSX.Element => (
  <Icon fill="currentColor" viewBox="0 0 20 20" className="h-5 w-5" {...props}>
